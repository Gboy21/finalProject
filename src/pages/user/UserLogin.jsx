  ...
  return (
    <div>
      <div className="flex flex-col justify-center h-screen text-center gap-y-10">
        ...
        <form className="flex flex-col px-6 gap-y-8 sm:px-60" onSubmit={handleSubmit(handleUserLogin)}>
          <AppInput
            fieldName="Email"
            type={"email"}
          ...
          />
          <AppButton type="submit" loading={isLoading} loadingText="Sending..." className="btn">
            SIGN IN
          </AppButton>
          <Typography className="text-[#0D98E5] cursor-pointer font-normal">
            <Link to="/user/reset-password">Forget Your Password?</Link>
          </Typography>
